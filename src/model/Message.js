...
export class Message extends Model {
    ...
    getViewElement(me = true) {
                                ...
                                <div class="_2cfqh">
                                    <div class="_1QMEq _1kZiz fS1bA">
                                        <div class="E5U9C">
                                            ...
                                            <button class="_2pQE3 audio-pause" style="display: none" class="btn-audio-pause">
        ...
        if(me) {
            ...
            div.querySelector('.msg-time').parentElement.appendChild(this.getStatusViewElement());
